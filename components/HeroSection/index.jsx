        ...
        <div className={`basic-color`} style={{paddingTop: "50px"}}>
            ...
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                {/* data-aos="fade-right" data-aos-delay="1000" data-aos-duration="1000" */}
                    ...
                    <h1 data-aos="fade-right" data-aos-duration="1000" class="[text-shadow:_0_3px_15px_rgb(0_0_0_/_60%)] max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl ">Chainzent</h1>
                    ...
                    <NavLink href="#" className="hex-color inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center border border-gray-300 rounded-lg hover:border-gray-500 text-white bg-primary-700 hover:bg-primary-800 hover:text-black ">
                ...
                <div className=" lg:mt-0 lg:col-span-5 lg:flex md:m-9"  style={{margin: "0"}}>
                    <img data-aos="zoom-in" data-aos-duration="2000" class="object-contain md:object-scale-down md:m-9 sm:m-9" src="/chainzent_logo_banner.png" alt="chainzent_logo" />
                </div>         
            </div>
            {/* <div class="test_item" data-aos="fade-up" style={{border: "2px solid red", width: "100%", height: "100px", backgroundColor: "red"}}></div> */}
        </div>
     );
}
